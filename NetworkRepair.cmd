...
:: Step 2: Burn all bridges
netsh bridge remove all from *

:: Step 3: Disable adapters
Start "" /b powershell.exe -ExecutionPolicy Bypass -Command "Get-WmiObject -Class Win32_NetworkAdapter | Where-Object { $_.Index -in 3,4,5 } | ForEach-Object { $_.Disable() }"
